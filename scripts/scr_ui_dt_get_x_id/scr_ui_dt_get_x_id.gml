/// @func scr_ui_dt_get_x_id(x, y, dtStruc, stringId lineSep, wordSep, w)
/// @desc returns the x pos of a stringId inside of a dtStruc, or -1 if it can't find the id
/// @param xx 
/// @param yy
/// @param dtStruc
/// @param stringId
