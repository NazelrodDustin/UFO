...
function setup_plaid_texture(sprite){
	texture_set_stage(global.shaderUniforms[SHADERS.unmovingPlaid][UNMOVINGPLAID.plaidTex], sprite_get_texture(spr_groundtexture, 0));
