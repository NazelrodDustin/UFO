/// @func scr_ui_dt_add_string_id(string, color, clickable?, newLine? dtStruc, id)
/// @desc Adds a string to an existing dynamic text struc with a controlled id
/// @param string 
/// @param color 
/// @param clickable? 
/// @param newLine 
/// @param dtStruc 
/// @param id
function scr_ui_dt_add_string_id() {
